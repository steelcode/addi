...
public class DalvikHookImpl extends DalvikHook {
	...
	public DalvikHookImpl(String clname, String method_name, String method_sig, String dex_method, String dex_class,DEXHook ih,int num_args, int mya, int skip){
		super(clname, method_name, method_sig, dex_method, dex_class,ih,num_args, mya, skip );
	}
