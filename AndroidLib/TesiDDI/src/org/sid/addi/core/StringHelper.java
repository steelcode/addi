...
public class StringHelper {
	public String _byteArrayToHex(byte[] a) {
	...
	public String _byteArrayToReadableStr(byte[] a) {
		   StringBuilder sb = new StringBuilder();
		   for(byte b: a) {
			   if (b >= 32 && b < 127)
	...
	public String _byteArrayToB64(byte[] a) {
		return Base64.encodeToString(a, Base64.NO_WRAP);
	}
	
	public Boolean _isItReadable(String input) {
	    int readableChar = 0;
...
//	        		c == 13 || c == 10 || c == 0) {
	...
	public String _escapeXMLChars(String s) {
		    return s.replaceAll("&",  "&amp;")
		         .replaceAll("'",  "&apos;")
		         .replaceAll("\"", "&quot;")
		         .replaceAll("<",  "&lt;")
	...
	public String _getReadableByteArr(byte[] input) {
